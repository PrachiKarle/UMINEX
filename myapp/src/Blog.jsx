...
const Blog = () => {
  ...
  const fetchData = async () => {
    var d = await axios.get("https://prachikarle.github.io/uminex_json/blog.json");
    console.log(d.data.blog);
    setBlog(d.data.blog);
  };
    ...
    <>
      ...
      <div className="row m-0 p-0">
        {blog.map((val, i) => {
          return (
            <>
              <div className="col-lg-4 col-md-6 col-12 p-4" key={i}>
                <div
                  className="h-100 w-100"
                  style={{ backgroundColor: "white" }}
                >
                  <div className="mb-2 div_2">
                    {" "}
